...
<body data-spy="scroll" data-target=".navbar-collapse" >
	...
	<form role="form" name="frm" ng-controller="main" action ="ManagerWorkScheduleSwitch" method="post" >
                ...
                <tr>
                        ...
                        <td>
                        		...
                        		<c:choose>
									...
									<c:when test="${empty row[0]}" >
									
									<div class="form-group row col-xs-6">
				                        <form role="form" class="" name="form1"  ng-controller="main" action ="ManagerWorkScheduleSwitchEdit" method="post" >
				                        <button class="btn"   ng-controller="main" name="edit" value="${row[9]}" ng-click=edit>
