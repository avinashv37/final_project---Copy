 ...
 */
@WebServlet("/EmployeeWorkScheduleSwitchEdit")
public class EmployeeWorkScheduleSwitchEdit extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EmployeeWorkScheduleSwitchEdit() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			loginc.EmployeeScheduleSwitchEdit(1,action,uid);
