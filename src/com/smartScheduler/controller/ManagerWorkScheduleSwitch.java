 ...
 */
@WebServlet("/ManagerWorkScheduleSwitch")
public class ManagerWorkScheduleSwitch extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ManagerWorkScheduleSwitch() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			result=loginc.ManagerSwitchingStatus(2,uid);
		...
		try {
			result=loginc.ManagerSwitchingStatus(3,uid);
